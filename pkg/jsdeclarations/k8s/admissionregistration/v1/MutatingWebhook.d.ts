...
export declare class MutatingWebhook {
    constructor();
    constructor(spec: Pick<MutatingWebhook, "admissionReviewVersions" | "clientConfig" | "failurePolicy" | "matchConditions" | "matchPolicy" | "name" | "namespaceSelector" | "objectSelector" | "reinvocationPolicy" | "rules" | "sideEffects" | "timeoutSeconds">);
