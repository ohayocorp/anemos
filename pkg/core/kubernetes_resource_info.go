...
func (info *KubernetesResourceInfo) populateBuiltInResources(version *semver.Version) {
	...
	default:
		if version.Major() == 1 && version.Minor() > 31 {
			slog.Warn(
				"Using Kubernetes version ${version} greater than 1.31, Anemos may not support all resources. Using 1.31 resources as a base.",
