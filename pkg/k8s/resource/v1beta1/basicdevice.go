...
func NewBasicDeviceWithSpec(spec *BasicDevice) *BasicDevice {
	
	return spec
}

func RegisterBasicDevice(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[BasicDevice]()).JsNamespace("k8s.resource.v1beta1").Fields(
		js.Field("AllNodes"),
		...
		js.Constructor(reflect.ValueOf(NewBasicDevice)),
		js.Constructor(reflect.ValueOf(NewBasicDeviceWithSpec)),
	)
}