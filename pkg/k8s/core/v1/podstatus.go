...
func NewPodStatusWithSpec(spec *PodStatus) *PodStatus {
	
	return spec
}

func RegisterPodStatus(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[PodStatus]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("Conditions"),
		js.Field("ContainerStatuses"),
		js.Field("EphemeralContainerStatuses"),
		js.Field("ExtendedResourceClaimStatus"),
		js.Field("HostIP"),
		js.Field("HostIPs"),
		js.Field("InitContainerStatuses"),
		js.Field("Message"),
		js.Field("NominatedNodeName"),
		...
		js.Field("Reason"),
		js.Field("Resize"),
		js.Field("ResourceClaimStatuses"),
		js.Field("StartTime"),
	).Constructors(
		js.Constructor(reflect.ValueOf(NewPodStatus)),
		js.Constructor(reflect.ValueOf(NewPodStatusWithSpec)),
	)
}