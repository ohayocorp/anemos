...
func NewContainerWithSpec(spec *Container) *Container {
	
	return spec
}

func RegisterContainer(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[Container]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("Args"),
		js.Field("Command"),
		js.Field("Env"),
		js.Field("EnvFrom"),
		...
		js.Constructor(reflect.ValueOf(NewContainer)),
		js.Constructor(reflect.ValueOf(NewContainerWithSpec)),
	)
}