...
func NewISCSIVolumeSource() *ISCSIVolumeSource {
	return &ISCSIVolumeSource{}
}

func NewISCSIVolumeSourceWithSpec(spec *ISCSIVolumeSource) *ISCSIVolumeSource {
	
	return spec
}

func RegisterISCSIVolumeSource(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[ISCSIVolumeSource]()).JsNamespace("k8s.core.v1").Fields(
		...
		js.Constructor(reflect.ValueOf(NewISCSIVolumeSource)),
		js.Constructor(reflect.ValueOf(NewISCSIVolumeSourceWithSpec)),
	)
}