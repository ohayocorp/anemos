...
type ServiceSpec struct {
	...
	Selector *any `json:"selector,omitempty" yaml:"selector,omitempty"`
...
func NewServiceSpecWithSpec(spec *ServiceSpec) *ServiceSpec {
	
	return spec
}

func RegisterServiceSpec(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[ServiceSpec]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("AllocateLoadBalancerNodePorts"),
		js.Field("ClusterIP"),
		js.Field("ClusterIPs"),
		js.Field("ExternalIPs"),
		js.Field("ExternalName"),
		js.Field("ExternalTrafficPolicy"),
		js.Field("HealthCheckNodePort"),
		js.Field("InternalTrafficPolicy"),
		js.Field("IpFamilies"),
		js.Field("IpFamilyPolicy"),
		js.Field("LoadBalancerClass"),
		js.Field("LoadBalancerIP"),
		js.Field("LoadBalancerSourceRanges"),
		js.Field("Ports"),
		js.Field("PublishNotReadyAddresses"),
		js.Field("Selector"),
		js.Field("SessionAffinity"),
		js.Field("SessionAffinityConfig"),
		js.Field("TrafficDistribution"),
		js.Field("Type"),
	).Constructors(
		js.Constructor(reflect.ValueOf(NewServiceSpec)),
		js.Constructor(reflect.ValueOf(NewServiceSpecWithSpec)),
	)
}