...
func NewPodAffinityWithSpec(spec *PodAffinity) *PodAffinity {
	
	return spec
}

func RegisterPodAffinity(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[PodAffinity]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("PreferredDuringSchedulingIgnoredDuringExecution"),
		js.Field("RequiredDuringSchedulingIgnoredDuringExecution"),
	).Constructors(
		js.Constructor(reflect.ValueOf(NewPodAffinity)),
		js.Constructor(reflect.ValueOf(NewPodAffinityWithSpec)),
	)
}