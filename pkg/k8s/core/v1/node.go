...
func NewNodeWithSpec(spec *Node) *Node {
	version := "v1"
	kind := "Node"
...
func RegisterNode(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[Node]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("ApiVersion"),
		js.Field("Kind"),
		js.Field("Metadata"),
		js.Field("Spec"),
	).Constructors(
		js.Constructor(reflect.ValueOf(NewNode)),
		js.Constructor(reflect.ValueOf(NewNodeWithSpec)),
	)
}