...
func NewPodAntiAffinityWithSpec(spec *PodAntiAffinity) *PodAntiAffinity {
	
	return spec
}

func RegisterPodAntiAffinity(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[PodAntiAffinity]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("PreferredDuringSchedulingIgnoredDuringExecution"),
		js.Field("RequiredDuringSchedulingIgnoredDuringExecution"),
	).Constructors(
		js.Constructor(reflect.ValueOf(NewPodAntiAffinity)),
		js.Constructor(reflect.ValueOf(NewPodAntiAffinityWithSpec)),
	)
}