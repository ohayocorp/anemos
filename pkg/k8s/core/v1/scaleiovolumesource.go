...
func NewScaleIOVolumeSource() *ScaleIOVolumeSource {
	return &ScaleIOVolumeSource{}
}

func NewScaleIOVolumeSourceWithSpec(spec *ScaleIOVolumeSource) *ScaleIOVolumeSource {
	
	return spec
}

func RegisterScaleIOVolumeSource(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[ScaleIOVolumeSource]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("FsType"),
		js.Field("Gateway"),
		...
		js.Constructor(reflect.ValueOf(NewScaleIOVolumeSource)),
		js.Constructor(reflect.ValueOf(NewScaleIOVolumeSourceWithSpec)),
	)
}