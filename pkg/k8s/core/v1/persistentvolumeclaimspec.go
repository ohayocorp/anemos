...
func NewPersistentVolumeClaimSpecWithSpec(spec *PersistentVolumeClaimSpec) *PersistentVolumeClaimSpec {
	
	return spec
}

func RegisterPersistentVolumeClaimSpec(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[PersistentVolumeClaimSpec]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("AccessModes"),
		js.Field("DataSource"),
		js.Field("DataSourceRef"),
		js.Field("Resources"),
		js.Field("Selector"),
		...
		js.Constructor(reflect.ValueOf(NewPersistentVolumeClaimSpec)),
		js.Constructor(reflect.ValueOf(NewPersistentVolumeClaimSpecWithSpec)),
	)
}