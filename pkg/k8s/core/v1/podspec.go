...
type PodSpec struct {
	...
	Overhead map[string]any `json:"overhead,omitempty" yaml:"overhead,omitempty"`
...
func NewPodSpecWithSpec(spec *PodSpec) *PodSpec {
	
	return spec
}

func RegisterPodSpec(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[PodSpec]()).JsNamespace("k8s.core.v1").Fields(
		js.Field("ActiveDeadlineSeconds"),
		js.Field("Affinity"),
		js.Field("AutomountServiceAccountToken"),
		js.Field("Containers"),
		js.Field("DnsConfig"),
		js.Field("DnsPolicy"),
		js.Field("EnableServiceLinks"),
		js.Field("EphemeralContainers"),
		js.Field("HostAliases"),
		js.Field("HostIPC"),
		js.Field("HostNetwork"),
		js.Field("HostPID"),
		js.Field("HostUsers"),
		js.Field("Hostname"),
		js.Field("HostnameOverride"),
		js.Field("ImagePullSecrets"),
		js.Field("InitContainers"),
		js.Field("NodeName"),
		...
		js.Field("Priority"),
		js.Field("PriorityClassName"),
		js.Field("ReadinessGates"),
		js.Field("ResourceClaims"),
		js.Field("Resources"),
		js.Field("RestartPolicy"),
		js.Field("RuntimeClassName"),
		js.Field("SchedulerName"),
		js.Field("SchedulingGates"),
		js.Field("SecurityContext"),
		js.Field("ServiceAccount"),
		js.Field("ServiceAccountName"),
		js.Field("SetHostnameAsFQDN"),
		js.Field("ShareProcessNamespace"),
		js.Field("Subdomain"),
		js.Field("TerminationGracePeriodSeconds"),
		js.Field("Tolerations"),
		js.Field("TopologySpreadConstraints"),
		js.Field("Volumes"),
	).Constructors(
		js.Constructor(reflect.ValueOf(NewPodSpec)),
		js.Constructor(reflect.ValueOf(NewPodSpecWithSpec)),
	)
}