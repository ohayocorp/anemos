...
type ObjectMeta struct {
	...
	Annotations *any `json:"annotations,omitempty" yaml:"annotations,omitempty"`
	...
	ManagedFields []*ManagedFieldsEntry `json:"managedFields,omitempty" yaml:"managedFields,omitempty"`
...
func NewObjectMetaWithSpec(spec *ObjectMeta) *ObjectMeta {
...
func RegisterObjectMeta(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[ObjectMeta]()).JsNamespace("k8s.apimachinery.meta.v1").Fields(
		...
		js.Field("Labels"),
		js.Field("ManagedFields"),
		js.Field("Name"),
		js.Field("Namespace"),
		js.Field("OwnerReferences"),
		js.Field("SelfLink"),
	).Constructors(
		js.Constructor(reflect.ValueOf(NewObjectMeta)),
		js.Constructor(reflect.ValueOf(NewObjectMetaWithSpec)),
	)
}