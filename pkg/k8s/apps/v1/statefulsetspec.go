...
func NewStatefulSetSpecWithSpec(spec *StatefulSetSpec) *StatefulSetSpec {
	
	return spec
}

func RegisterStatefulSetSpec(jsRuntime *js.JsRuntime) {
	jsRuntime.Type(reflect.TypeFor[StatefulSetSpec]()).JsNamespace("k8s.apps.v1").Fields(
		js.Field("MinReadySeconds"),
		js.Field("Ordinals"),
		js.Field("PersistentVolumeClaimRetentionPolicy"),
		js.Field("PodManagementPolicy"),
		js.Field("Replicas"),
		js.Field("RevisionHistoryLimit"),
		js.Field("Selector"),
		js.Field("ServiceName"),
		js.Field("Template"),
		js.Field("UpdateStrategy"),
		js.Field("VolumeClaimTemplates"),
	).Constructors(
		js.Constructor(reflect.ValueOf(NewStatefulSetSpec)),
		js.Constructor(reflect.ValueOf(NewStatefulSetSpecWithSpec)),
	)
}