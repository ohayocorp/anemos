...
import { NetworkPolicyEgressRule } from "./NetworkPolicyEgressRule"
import { NetworkPolicyIngressRule } from "./NetworkPolicyIngressRule"
...
export declare class NetworkPolicySpec {
    constructor();
    constructor(spec: Pick<NetworkPolicySpec, "egress" | "ingress" | "podSelector" | "policyTypes">);
